	...
	private function remove_marketplace_modules_for_purge()
	{
		...
		try
		{
			...
			$module_langnames = [
				...
				'MARKETPLACE_ACP_FINANCIAL_REPORTS',
				'MARKETPLACE_ACP_SECURITY',
				'MARKETPLACE_ACP_ADMIN_LOGS',
				'MARKETPLACE_ACP_PROMOTIONS',
				'MARKETPLACE_ACP_PAYMENTS',
				'UCP_MARKETPLACE_TITLE',
				'UCP_MARKETPLACE_OVERVIEW',
				'UCP_MARKETPLACE_ADS',
				'UCP_MARKETPLACE_PROMOTIONS',
				'UCP_MARKETPLACE_NOTIFICATIONS',
				'UCP_MARKETPLACE_PURCHASES',
				'UCP_MARKETPLACE_SALES',
				'UCP_MARKETPLACE_FAVORITES',
				'UCP_MARKETPLACE_CONVERSATIONS',
				'UCP_MARKETPLACE_PAYMENTS',
			];
